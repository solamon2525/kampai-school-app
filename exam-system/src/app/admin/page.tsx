                ...
                <div className="w-full max-w-sm">
                    <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                        <div className="text-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-gray-800">ระบบจัดการข้อสอบ</h2>
                            <p className="text-gray-500 text-sm mt-2">กรุณากรอกรหัสผ่านของคุณครู</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-4">
                            <div>
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors text-center text-lg tracking-widest"
                                    autoFocus
                                />
                                {authError && (
                            ...
                            <button
                                type="submit"
                                className="w-full px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-colors shadow-md shadow-indigo-200"
                            >
                                เข้าสู่ระบบ
                            </button>
                        </form>
                        ...
                        <div className="mt-6 pt-6 border-t">
                            <a href={HOME_URL} className="text-center block text-sm text-indigo-600 hover:underline">
                                ← กลับสู่หน้าหลัก
                            </a>
                        </div>
                    </div>
